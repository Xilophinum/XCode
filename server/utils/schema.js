...
export function createSchema(dbType = 'sqlite') {
  if (dbType === 'postgres' || dbType === 'postgresql') {
    ...
    return {
      users: pgTable('users', {
        ...
        passwordChangeRequired: pgVarchar('password_change_required', { length: 10 }).notNull().default('false'),
  ...
  if (dbType === 'mysql') {
    ...
    return {
      users: mysqlTable('users', {
        ...
        passwordChangeRequired: mysqlVarchar('password_change_required', { length: 10 }).notNull().default('false'),
  ...
  return {
    users: sqliteTable('users', {
      ...
      passwordChangeRequired: text('password_change_required').notNull().default('false'),
